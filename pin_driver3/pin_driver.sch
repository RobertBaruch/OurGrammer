...
U 1 1 5E56C1FB
P 3550 2050
F 0 "#FLG01" H 3550 2125 50  0001 C CNN
F 1 "PWR_FLAG" H 3550 2223 50  0000 C CNN
...
U 1 1 5E1C3643
P 8650 5850
F 0 "#FLG04" H 8650 5925 50  0001 C CNN
...
U 1 1 5E737600
P 11650 4850
F 0 "#PWR012" H 11450 4700 50  0001 C CNN
...
U 1 1 5E73E9B0
P 12150 4700
F 0 "#PWR011" H 11950 4550 50  0001 C CNN
...
U 1 1 5E744E02
P 10250 5650
F 0 "#PWR015" H 10050 5500 50  0001 C CNN
...
U 1 1 5E757DE3
P 14200 2100
F 0 "#PWR03" H 14200 1950 50  0001 C CNN
...
U 1 1 5E94F33B
P 3550 2650
F 0 "#FLG03" H 3550 2725 50  0001 C CNN
F 1 "PWR_FLAG" H 3550 2823 50  0000 C CNN
...
U 1 1 5E9A044F
P 14550 2950
F 0 "J2" H 14630 2942 50  0000 L CNN
...
U 1 1 5EB580E2
P 12200 2450
F 0 "#FLG02" H 12200 2525 50  0001 C CNN
...
Wire Wire Line
	3550 3750 3550 6000
$Comp
L conn_02x32_row_capletter_first:Conn_02x32_Row_CapLetter_First J3
U 1 1 5E303934
P 4050 3550
F 0 "J3" H 4100 5267 50  0000 C CNN
F 1 "MAIN CONN" H 4100 5176 50  0000 C CNN
...
F0 "Decoder" 50
F1 "decoder.sch" 50
F2 "CLK" I L 6000 4350 50 
F3 "A[0..8]" I L 6000 4450 50 
F4 "CLK0" O R 6750 4350 50 
F5 "CLK1" O R 6750 4450 50 
F6 "B[1..8]" I L 6000 4550 50 
$EndSheet
Wire Wire Line
	3850 4350 2850 4350
Wire Wire Line
...
Wire Wire Line
	5100 4350 6000 4350
Wire Wire Line
	10400 2150 7150 2150
Wire Wire Line
	7150 2150 7150 4350
Wire Wire Line
	7150 4350 6750 4350
Wire Wire Line
	10400 4600 7150 4600
Wire Wire Line
	7150 4600 7150 4450
Wire Wire Line
	7150 4450 6750 4450
...
U 1 1 5E5264A6
P 4400 5250
F 0 "#PWR014" H 4400 5000 50  0001 C CNN
F 1 "GNDREF" H 4405 5077 50  0001 C CNN
...
F 1 "GNDREF" H 3805 5077 50  0001 C CNN
